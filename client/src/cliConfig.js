//this is for extract the commands from the terminal line
...
export default class CliConfig {
    ...
    static parseArguments(commands) {
        ...
        for(const key in commands) {
            ...
            cmd.set(
                command.replace(commandPreffix, ''), // this is for getting the command
                commands[index + 1] // this is for getting the value, like after the --room for example
            )
        }
